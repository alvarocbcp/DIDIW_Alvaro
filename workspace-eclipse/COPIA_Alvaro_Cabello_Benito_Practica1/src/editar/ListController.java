...
public class ListController {
	...
	void initialize() {
		...
		genero.selectedToggleProperty().addListener(new ChangeListener<Toggle>() {

			@Override
			public void changed(ObservableValue<? extends Toggle> observable, Toggle oldValue, Toggle newValue) {
				RadioButton rb = (RadioButton) genero.getSelectedToggle();
				if(rb==hombreAnadir) {
					Image img = new Image(getClass().getResourceAsStream("/img/masculino.png"));
					imgGenero.setImage(img);
				}
				else if(rb==mujerAnadir) {
					Image img = new Image(getClass().getResourceAsStream("/img/femenino.png"));
					imgGenero.setImage(img);
				}
			}
		});
